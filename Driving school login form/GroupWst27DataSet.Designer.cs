...
SELECT PaymentID, BookingID, AmountPaid, PaymentMethod, PaymentStatus, PaymentDate FROM Payment WHERE (PaymentID = @PaymentID)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[1].CommandText = "SELECT AmountPaid, PaymentMethod, PaymentStatus, PaymentDate FROM dbo.Payment";
        ...
        public virtual int FillBy(GroupWst27DataSet.PaymentDataTable dataTable) {
        ...
        public virtual GroupWst27DataSet.PaymentDataTable GetDataBy() {
            this.Adapter.SelectCommand = this.CommandCollection[1];
            GroupWst27DataSet.PaymentDataTable dataTable = new GroupWst27DataSet.PaymentDataTable();
            this.Adapter.Fill(dataTable);
            return dataTable;
